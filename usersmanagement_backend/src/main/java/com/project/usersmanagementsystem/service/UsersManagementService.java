...
import com.project.usersmanagementsystem.dto.ReqRes;
import com.project.usersmanagementsystem.entity.OurUsers;
import com.project.usersmanagementsystem.repository.UserRepo;
...
public class UsersManagementService {
    ...
    public ReqRes getUsersById(Long id){
        ReqRes reqRes = new ReqRes();
        try {
            OurUsers usersById = userRepo.findById(id).orElseThrow(() -> new RuntimeException("Users not found"));
